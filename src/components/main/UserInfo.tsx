    ...
    return (
        <Box sx={{
            ...
            <Typography sx={{fontSize: "18px", color: "#113883"}}>
                Welcome, <span style={{color: "#FBA24F"}}>
                {user.firstName}
            </span>
            </Typography>
            <Box sx={{
                ...
                <Box sx={{position: "relative", height: "200px", width: "200px", px: "20px"}}>
                    <CircularProgress size={200} value={100} variant="determinate"
                                      sx={{position: "absolute", color: "white"}}/>
                    <CircularProgress size={200} value={user.storage.used * 100 / user.storage.max}
                                      variant="determinate"
                ...
                <Typography sx={{
                    color: "#7A7A7A",
                    fontSize: "12px"
                }}>{formatFileSize(user.storage.used)} of {formatFileSize(user.storage.max)} are used</Typography>
                <Button
                    sx={{bgcolor: "#FBA24F", color: "white", textTransform: "none", "&:hover": {bgcolor: "#efae75"}}}>Buy
                    more storage</Button>
            </Box>
            <Box sx={{display: "flex", flexDirection: "column", alignItems: "center", mt: "46px " }}>
                <label htmlFor="files" className="btn">
                    <Box sx={{
                        ...
                        <Typography sx={{fontWeight: 400, color: "#CCCCCC", fontSize: "12px your"}}>support all files  format</Typography>
